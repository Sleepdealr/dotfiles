...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspinstall', 'nvim-colorizer.lua', 'lspkind-nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'plenary.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
